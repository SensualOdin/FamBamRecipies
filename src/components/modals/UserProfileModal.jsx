        ...
        <div className="relative bg-gradient-to-r from-blue-600 via-cyan-600 to-blue-700 p-8 text-white overflow-hidden">
          ...
          <div className="relative flex items-start gap-6">
            ...
            <div className="relative group">
              <div className="w-32 h-32 bg-white rounded-3xl flex items-center justify-center text-7xl shadow-2xl overflow-hidden">
              ...
              <div className="absolute -bottom-2 -right-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-4 py-2 rounded-xl font-bold text-sm shadow-lg flex items-center gap-1">
